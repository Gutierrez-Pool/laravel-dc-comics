...
@section('content')
    <div class="container py-5">
        ...
        <h2 class="pb-3">Aggiungi comic</h2>
        ...
        <form action="{{route('comics.store')}}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('series') is-invalid @enderror" name="series" id="series" value="{{old("series")}}" required>
                @error('series')
                    <div class="invalid-feedback">
                        {{$message}}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('type') is-invalid @enderror" name="type" id="type" value="{{old("type")}}" required>
                @error('type')
                    <div class="invalid-feedback">
                        {{$message}}
                    </div>
